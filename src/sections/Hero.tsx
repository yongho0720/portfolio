...
export function Hero() {
  return <section className="hero" id="top">
    ...
    <div className="hero-copy">
      <p className="eyebrow"><span>AI SERVICE DEVELOPMENT</span> / PORTFOLIO 2026</p>
      <h1><span>AI 활용 서비스</span><br />개발 포트폴리오</h1>
      <p className="hero-lede">아이디어를 구체화하고, 설계하고,<br />개발 · 검증 · 배포까지.<br /><strong>AI 에이전트와 함께 실제 서비스를 만듭니다.</strong></p>
